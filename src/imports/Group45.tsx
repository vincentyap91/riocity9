import svgPaths from "./svg-2kon9sou17";
import imgRc9ReferralBannerDesktop1544X45111 from "@/assets/9cc12ccab5ff73c2e07714865ae6549ed3409f4c.png";

function Background() {
  return (
    <div className="absolute contents left-0 top-0" data-name="background">
      <div className="absolute bg-[#1c3f37] h-[450px] left-0 rounded-[20px] top-px w-[1544px]" />
      <div className="absolute h-[450px] left-px rounded-[20px] top-0 w-[1544px]" data-name="RC9_ReferralBanner_Desktop_1544x451_1 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[20px] size-full" src={imgRc9ReferralBannerDesktop1544X45111} />
      </div>
    </div>
  );
}
...
function Buttons() {
  return (
    <div className="absolute contents left-[270px] top-[267px]" data-name="Buttons">
      <MoreInfoButton />
      <DownlineButton />
      <ShareButton />
    </div>
...
function Frame() {
  return (
    <div className="absolute left-[605px] size-[20px] top-[201px]" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_372_3356)" id="Frame">
          <path d={svgPaths.p8576f40} fill="var(--fill-0, #F0D10C)" id="Vector" stroke="var(--stroke-0, #F0D10C)" />
        </g>
        <defs>
          <clipPath id="clip0_372_3356">
...
function Frame1() {
  return (
    <div className="absolute left-[605px] size-[20px] top-[99px]" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_372_3356)" id="Frame">
          <path d={svgPaths.p8576f40} fill="var(--fill-0, #F0D10C)" id="Vector" stroke="var(--stroke-0, #F0D10C)" />
        </g>
...
function Group() {
  return (
    <div className="absolute contents left-[270px] top-[63px]">
      <Buttons />
      <TextFill />
      <TextFill1 />
    </div>
...
function Form() {
  return (
    <div className="absolute contents left-[245px] top-[41.35px]" data-name="Form">
      <div className="absolute bg-[#125a48] h-[376px] left-[245px] rounded-[15px] top-[41.35px] w-[425px]" />
      <Group />
    </div>
  );
}

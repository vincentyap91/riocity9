        ...
        <div className="w-full md:w-[55%] bg-[#1a2230] p-6 md:p-10 flex flex-col justify-center">
          ...
          >
            ...
            >
                <Button 
                    variant="outline"
                    className="w-full h-12 bg-[rgba(37,211,102,0.1)] border-[rgba(37,211,102,0.3)] hover:bg-[rgba(37,211,102,0.2)] text-[#25d366] hover:text-[#25d366] font-bold text-base rounded-xl border-solid transition-all flex items-center justify-center gap-2"
                >

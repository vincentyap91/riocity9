        ...
        <div className="container mx-auto max-w-[1200px] 2xl:max-w-[1536px] px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-10 items-end">
            ...
            <div className="space-y-6">
              ...
              {/* Referral Code & Link - Single Row - Only show if logged in */}
              {isAuthenticated && (
                <>
                  <div className="bg-[#1A2230] border border-[#2f362f] rounded-xl inline-flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-[#2f362f] shadow-[0_0_0_1px_rgba(255,255,255,0.04)]">
                    {/* My Referral Code */}

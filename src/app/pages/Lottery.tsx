...
import { Ticket, Hash, Clock, Grid } from 'lucide-react';
...
const lotteryNavItems: PageNavItem[] = [
    { id: 'all', label: 'All Lottery', icon: Grid, isActive: true },
    { id: 'keno', label: 'Keno', icon: Hash },
    { id: 'lotto', label: 'Lotto', icon: Ticket },
    { id: 'fast', label: 'Fast Draws', icon: Clock },
];
  ...
  return (
    <div className="flex flex-col gap-8 pb-24 flex-1 overflow-x-hidden bg-[#02040a]">
        ...
        <div className="mt-[-20px] relative z-20">
            <InsidePageHeader title="Lottery & Keno" navItems={lotteryNavItems} iconColor="text-purple-500" />
        </div>
        ...
        <div className="container mx-auto max-w-[1200px] 2xl:max-w-[1536px] px-4 mt-4">
            ...
            <div className="mt-8 flex flex-col gap-4">
                <div className="bg-[#1a2536] border border-white/5 rounded-2xl p-6 flex items-center justify-between">
                    <div>
                        <div className="text-purple-400 font-bold mb-1">Next Draw: Keno 24/7</div>
